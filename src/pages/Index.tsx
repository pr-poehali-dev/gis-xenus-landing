    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="bg-white border-b border-gray-100 px-4 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold text-[#151515] font-montserrat">XENUS</span>
          </div>
      ...
      <section id="advantages" className="py-20 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-[#151515] mb-8 font-montserrat">Преимущества XENUS</h2>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-[#151515] mb-2">Полная импортонезависимость</h3>
                    <p className="text-gray-600">Отечественное решение, соответствующее требованиям безопасности и независимости от зарубежных технологий</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-[#151515] mb-2">Модульная архитектура</h3>
                    <p className="text-gray-600">Гибкая система позволяет использовать только необходимые модули и легко масштабировать решение</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-[#151515] mb-2">Гибкая адаптация</h3>
                    <p className="text-gray-600">Возможность настройки под специфику любой отрасли и интеграция с существующими системами</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-[#151515] mb-2">Гибкие варианты поставки</h3>
                    <p className="text-gray-600">Веб-интерфейс, on-premise решения, облачное развёртывание и API для интеграций</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="industries" className="py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-[#151515] mb-4 font-montserrat">Области применения</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
            <div className="text-center p-6 bg-gray-50 rounded-xl hover:bg-[#4dfbde]/10 transition-all duration-300 hover-scale">
              ...
              <h3 className="text-lg font-semibold text-[#151515] mb-2">ЖКХ</h3>
              <p className="text-gray-600 text-sm">Управление жилищно-коммунальным хозяйством и инфраструктурой</p>
            </div>
            ...
            <div className="text-center p-6 bg-gray-50 rounded-xl hover:bg-[#4dfbde]/10 transition-all duration-300 hover-scale">
              ...
              <h3 className="text-lg font-semibold text-[#151515] mb-2">Промышленность</h3>
              <p className="text-gray-600 text-sm">Мониторинг промышленных объектов и оптимизация производства</p>
            </div>
            ...
            <div className="text-center p-6 bg-gray-50 rounded-xl hover:bg-[#4dfbde]/10 transition-all duration-300 hover-scale">
              ...
              <h3 className="text-lg font-semibold text-[#151515] mb-2">Экология</h3>
              <p className="text-gray-600 text-sm">Экологический мониторинг и анализ воздействия на окружающую среду</p>
            </div>
            ...
            <div className="text-center p-6 bg-gray-50 rounded-xl hover:bg-[#4dfbde]/10 transition-all duration-300 hover-scale">
              ...
              <h3 className="text-lg font-semibold text-[#151515] mb-2">Транспорт</h3>
              <p className="text-gray-600 text-sm">Управление транспортными потоками и логистическими системами</p>
            </div>
            ...
            <div className="text-center p-6 bg-gray-50 rounded-xl hover:bg-[#4dfbde]/10 transition-all duration-300 hover-scale">
              ...
              <h3 className="text-lg font-semibold text-[#151515] mb-2">Энергетика</h3>
              <p className="text-gray-600 text-sm">Мониторинг энергетической инфраструктуры и оптимизация сетей</p>
            </div>
          </div>

          {/* Development roadmap */}
          <div className="mt-16 bg-[#4dfbde]/5 rounded-2xl p-8">
            <h3 className="text-2xl font-bold text-[#151515] mb-6 text-center font-montserrat">Направления развития</h3>
            <div className="grid md:grid-cols-4 gap-6">
              <div className="text-center">
                ...
                <h4 className="font-semibold text-[#151515] mb-2">BIM-интеграция</h4>
                <p className="text-sm text-gray-600">Работа с моделями зданий и сооружений</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-[#4dfbde] rounded-lg flex items-center justify-center mx-auto mb-3">
                  <Icon name="Globe" size={24} className="text-[#151515]" />
                </div>
                <h4 className="font-semibold text-[#151515] mb-2">Умный город</h4>
                <p className="text-sm text-gray-600">Комплексные решения для городской среды</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-[#4dfbde] rounded-lg flex items-center justify-center mx-auto mb-3">
                  <Icon name="Target" size={24} className="text-[#151515]" />
                </div>
                <h4 className="font-semibold text-[#151515] mb-2">ЦУР</h4>
                <p className="text-sm text-gray-600">Центры управления регионами</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-[#4dfbde] rounded-lg flex items-center justify-center mx-auto mb-3">
                  <Icon name="Cpu" size={24} className="text-[#151515]" />
                </div>
                <h4 className="font-semibold text-[#151515] mb-2">Автонастройка</h4>
                <p className="text-sm text-gray-600">ИИ для автоматической настройки аналитики</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <CardContent className="p-8">
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <Input placeholder="Название организации" className="border-gray-300" />
                </div>

                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Отрасль</label>
                  <Input placeholder="ЖКХ, промышленность, транспорт..." className="border-gray-300" />
                </div>
